...
var _adbkitApkreader = require('adbkit-apkreader');

var _adbkitApkreader2 = _interopRequireDefault(_adbkitApkreader);
...
var Upload = (function () {
    ...
    _createClass(Upload, [{
        ...
        value: function parseManifest() {
            ...
            return _adbkitApkreader2['default'].open(this.apk[0]).then(function (reader) {
